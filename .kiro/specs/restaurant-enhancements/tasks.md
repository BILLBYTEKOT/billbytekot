...
- [ ] 1. Fix Table Status Immediate Sync
  - [ ] 1.1 Create TableStatusManager in backend with direct DB updates
  ...
  - [ ] 1.2 Update order creation endpoint to use TableStatusManager
  ...
  - [ ] 1.4 Write property test for table status sync
    - **Property 1: Table Status Synchronization**
    - **Validates: Requirements 1.1, 1.2, 1.4**

- [ ] 2. Fix TablesPage to fetch fresh data
  - [ ] 2.1 Update TablesPage fetchTables to always bypass cache
    - Add `?fresh=true` parameter to force DB read
    - Remove reliance on cached data for table status
    - _Requirements: 1.5_
  - [ ] 2.2 Add auto-refresh after order/bill operations
...
- [ ] 4. Add Menu Loading States
  - [ ] 4.1 Add loading state to BillingPage menu fetch
    - Show skeleton UI while menu is loading
    - Display loading spinner within 100ms of navigation
    - _Requirements: 2.1, 2.5_
  - [ ] 4.2 Add error handling with retry for menu fetch
    - Display error message on fetch failure
    - Add retry button
    - _Requirements: 2.3_
  - [ ] 4.3 Add localStorage caching for menu items
    - Cache menu items with timestamp
    - Use cached data for instant display, refresh in background
    - _Requirements: 2.4_

- [ ] 5. Enhance Inventory - Supplier Management
  - [ ] 5.1 Add Supplier model and CRUD endpoints in backend
    ...
    - _Requirements: 3.2_
  - [ ] 5.2 Add Supplier creation dialog in InventoryPage
...
- [ ] 6. Enhance Inventory - Category Management
  - [ ] 6.1 Add Category model and CRUD endpoints in backend
    ...
    - _Requirements: 3.3_
  - [ ] 6.2 Add Category creation dialog in InventoryPage
...
- [ ] 7. Fix Inventory Item Save Issues
  - [ ] 7.1 Add proper validation to inventory item save
  ...
  - [ ] 7.2 Fix inventory item form to properly link supplier and category
...
- [ ] 9. Implement Expense Management Backend
  - [ ] 9.1 Create Expense model and collection in MongoDB
    - Define Expense Pydantic model with all fields
    - Add expense categories constant list
    - _Requirements: 4.2, 4.3_
  - [ ] 9.2 Add Expense CRUD endpoints
...
- [ ] 12. Implement Day Book / Cash Flow Report Frontend
  ...
  - [ ] 12.3 Add export buttons for PDF and Excel
    - Download functionality for both formats
    - _Requirements: 5.6_
  - [ ] 12.4 Write property test for transaction categorization
