  ...
  const features = [
    {
      ...
      description: 'Smart recommendations, sales forecasting, and automated insights powered by GPT-4',
      color: 'from-violet-500 to-purple-600'
    },
    {
      icon: CreditCard,
      title: 'Multiple Payment Options',
      description: 'Accept cash, cards, UPI, and Razorpay. EDC machine support included',
      color: 'from-blue-500 to-cyan-600'
    },
    {
      icon: Printer,
      title: 'Thermal Printer Support',
      description: '4 professional receipt themes. ESC/POS compatible thermal printing',
      color: 'from-green-500 to-emerald-600'
    },
    {
      icon: Globe,
      title: 'Multi-Currency Support',
      description: 'Support 10+ currencies including INR, USD, EUR, GBP, AED, and more',
      color: 'from-orange-500 to-amber-600'
    },
    {
      icon: Users,
      title: 'Staff Management',
      description: 'Role-based access for admin, cashiers, waiters, and kitchen staff',
    ...
    },
    {
      ...
      description: 'Track stock levels, get low-stock alerts, and manage suppliers',
      color: 'from-teal-500 to-cyan-600'
    },
    {
      icon: Smartphone,
      title: 'Mobile & PWA Ready',
      description: 'Works on any device. Install as Android app from Play Store',
  ...
  const benefits = [
    {
      ...
      description: 'Process orders in seconds with smart menu and quick billing'
    },
    {
      icon: DollarSign,
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="landing-page">
        ...
        <nav className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                RestoBill AI
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Button className="bg-gradient-to-r from-violet-600 to-purple-600" onClick={handleGetStarted}>
                Get Started Free
              </Button>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-4">
              <a href="#features" className="block text-gray-600 hover:text-violet-600">Features</a>
              <a href="#pricing" className="block text-gray-600 hover:text-violet-600">Pricing</a>
              <a href="#testimonials" className="block text-gray-600 hover:text-violet-600">Reviews</a>
              <a href="#faq" className="block text-gray-600 hover:text-violet-600">FAQ</a>
              <Button variant="outline" className="w-full" onClick={() => navigate('/login')}>Login</Button>
              <Button className="w-full bg-gradient-to-r from-violet-600 to-purple-600" onClick={handleGetStarted}>
                Get Started Free
              </Button>
            </div>
          )}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-100 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-violet-600">AI-Powered Restaurant Management</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your restaurant with AI-powered billing, multi-currency support, and thermal printing. Try free for 50 bills!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button size="lg" variant="outline" className="h-14 px-8 text-lg" onClick={() => document.getElementById('demo').scrollIntoView({ behavior: 'smooth' })}>
                Watch Demo
              </Button>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Why RestoBill AI?</h2>
            <p className="text-xl text-gray-600">The complete solution for modern restaurants</p>
          </div>
      ...
      <section id="features" className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Powerful Features</h2>
      ...
      <section id="testimonials" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Loved by Restaurants</h2>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 bg-gradient-to-br from-violet-50 to-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Simple Pricing</h2>
            <p className="text-xl text-gray-600">Start free, upgrade when you grow</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card key={index} className={`border-0 shadow-2xl relative ${plan.popular ? 'ring-2 ring-violet-600' : ''}`}>
                {plan.popular && (
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Frequently Asked Questions</h2>
          </div>
      ...
      {/* CTA Section */}
      <section id="demo" className="py-20 bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
            Ready to Transform Your Restaurant?
          </h2>
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join 10,000+ restaurants using RestoBill AI. Start free, no credit card required.
          </p>
          ...
          <form onSubmit={handleWaitlist} className="max-w-md mx-auto">
            <div className="flex gap-2">
              <Input
                ...
                required
              />
              <Button type="submit" className="bg-white text-violet-600 hover:bg-gray-100 h-12 px-6">
                Join Waitlist
              </Button>
            </div>
          </form>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                AI-powered restaurant billing system trusted by 10,000+ restaurants worldwide.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
            <p>© 2024 RestoBill AI. All rights reserved. Made with ❤️ in India</p>
          </div>
        </div>
      </footer>
    </div>
